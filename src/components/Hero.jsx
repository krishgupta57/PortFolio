      ...
      <div className="grid md:grid-cols-[1fr_auto] gap-12 items-center w-full relative">
        ...
        <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="space-y-8 z-10 w-full max-w-2xl">
          ...
          <motion.div variants={fadeIn} className="flex flex-wrap items-center gap-6 pt-4">
            <a href="#projects" className="px-10 py-5 bg-gradient-to-r from-pink-600 to-blue-600 hover:from-pink-500 hover:to-blue-500 text-white rounded-2xl font-black uppercase tracking-widest text-xs transition-all shadow-[0_15px_30px_rgba(236,72,153,0.3)] hover:shadow-[0_20px_40px_rgba(236,72,153,0.4)] hover:-translate-y-1 active:translate-y-0 cursor-none">
              Explore Projects
            </a>
            <button onClick={() => setIsZoomed(true)} className="px-10 py-5 bg-slate-900 border border-slate-800 text-slate-300 hover:text-white hover:border-pink-500/50 rounded-2xl font-black uppercase tracking-widest text-xs transition-all hover:bg-slate-800 hover:-translate-y-1 active:translate-y-0 shadow-xl cursor-none">
              Zoom Resume
            </button>
