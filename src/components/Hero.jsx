...
const CyberButton = ({ children, onClick, href, className, primary }) => {
...
const Hero = () => {
  ...
  return (
    <section id="hero" className="min-h-[60vh] flex items-center relative border-none w-full py-12">
      ...
      {/* High-Density Data Flows */}
      <div className="absolute top-0 left-[20%] w-[1px] h-full z-0 opacity-10 pointer-events-none hidden lg:block">
        <div className="conduit-lane">
          <div className="conduit-pulse" style={{ animationDuration: '4s', animationDelay: '-1s' }} />
        </div>
      </div>
      <div className="absolute top-0 right-[20%] w-[1px] h-full z-0 opacity-15 pointer-events-none hidden lg:block">
        <div className="conduit-lane">
          <div className="conduit-pulse" style={{ animationDuration: '6s', animationDelay: '-3s' }} />
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-[1fr_auto] gap-12 items-center w-full relative">
        ...
        <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="space-y-8 z-10 w-full max-w-2xl">
          <motion.div variants={fadeIn} className="flex items-center space-x-3 text-pink-400 font-mono text-sm bg-pink-500/10 border border-pink-500/20 px-5 py-2.5 rounded-full w-fit shadow-[0_0_15px_rgba(236,72,153,0.1)]">
          ...
          <motion.h1 variants={fadeIn} className="text-5xl md:text-8xl font-black text-white tracking-tighter mb-8 leading-none group">
            Digital <br />
            <span className="text-pink-blue inline-block animate-glitch">Architect</span>
          </motion.h1>
          ...
          <motion.div variants={fadeIn} className="flex flex-wrap items-center gap-6 pt-4">
            <CyberButton 
              href="#projects" 
              primary={true}
              className="px-10 py-5 bg-gradient-to-r from-pink-600 to-blue-600 hover:from-pink-500 hover:to-blue-500 text-white rounded-2xl font-black uppercase tracking-widest text-xs transition-shadow shadow-[0_15px_30px_rgba(236,72,153,0.3)] hover:shadow-[0_20px_40px_rgba(236,72,153,0.4)]"
            >
              Explore Projects
            </CyberButton>
            <CyberButton 
              onClick={() => setIsZoomed(true)} 
              className="px-10 py-5 bg-slate-900 border border-slate-800 text-slate-300 hover:text-white hover:border-pink-500/50 rounded-2xl font-black uppercase tracking-widest text-xs transition-colors hover:bg-slate-800 shadow-xl"
            >
              Zoom Resume
            </CyberButton>
